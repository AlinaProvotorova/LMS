...
urlpatterns = [
    ...
    path(
        '<str:role>/education_of/<id_education>', EducationOflineView.as_view(),
        name='education_detail_ofline'
    ),
    path(
